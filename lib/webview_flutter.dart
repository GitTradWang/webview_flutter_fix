...
class WebView extends StatefulWidget {
  ...
  /// will setCookie before load URL
...
class _PlatformCallbacksHandler implements WebViewPlatformCallbacksHandler {
  ...
  bool onNavigationRequest({String url, bool isForMainFrame}) {
    ...
    final bool allowNavigation = _widget.navigationDelegate == null || _widget.navigationDelegate(request) == NavigationDecision.navigate;
...
class WebViewController {
  ...
  Future<String> evaluateJavascript(String javascriptString) {
    if (_settings.javascriptMode == JavascriptMode.disabled) {
      return Future<String>.error(FlutterError('JavaScript mode must be enabled/unrestricted when calling evaluateJavascript.'));
    }
