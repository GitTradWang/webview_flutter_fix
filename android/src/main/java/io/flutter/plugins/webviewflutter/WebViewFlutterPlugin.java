...
public class WebViewFlutterPlugin implements FlutterPlugin {
    ...
    public static void registerWith(Registrar registrar) {
        registrar
                ...
                .registerViewFactory("plugins.flutter.io/webview", new WebViewFactory(registrar.messenger(), registrar.view()));
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        ...
        binding
                ...
                .getRegistry()
                .registerViewFactory("plugins.flutter.io/webview", new WebViewFactory(messenger, /*containerView=*/ null));
